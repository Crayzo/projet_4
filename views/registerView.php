    ...
    <form action="" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-12">
                ...
                <input type="mail" class="form-control" name="mail" id="mail" placeholder="Votre mail" value="<?php if(isset($mail)){echo $mail;} ?>" required>
            </div>
            <div class="form-group col-12">
                <label for="mail2">Confirmation du mail</label>
                <input type="mail" class="form-control" name="mail2" id="mail2" placeholder="Confirmation de votre mail" value="<?php if(isset($mail2)){echo $mail2;} ?>" required>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-12">
